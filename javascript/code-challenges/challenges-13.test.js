...
const longestString = (arr) => {
  ...
  var longest = arr.reduce(function (acc, element) {
...
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
Write acc function named firstLetters that takes in an array of strings and returns an array containing only the first letter of each string.
